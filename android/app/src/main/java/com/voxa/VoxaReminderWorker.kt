...
internal data class VoxaReminder(
    val id: String,
    val title: String,
    val body: String,
...
internal object VoxaReminderScheduler {
  private const val REMINDER_TAG = "voxa-inactivity-reminders"

  fun schedule(context: Context, reminders: List<VoxaReminder>) {
    ...
    reminders.forEach { reminder ->
      val input =
          Data.Builder()
              .putString(VoxaReminderWorker.KEY_ID, reminder.id)
              .putString(VoxaReminderWorker.KEY_TITLE, reminder.title)
              .putString(VoxaReminderWorker.KEY_BODY, reminder.body)
              .build()
      val request =
          OneTimeWorkRequest.Builder(VoxaReminderWorker::class.java)
...
class VoxaReminderWorker(
  ...
  companion object {
    ...
    private const val CHANNEL_ID = "voxa_gentle_reminders"
