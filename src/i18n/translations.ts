...
export const LOCALE_NAMES: Record<LocaleCode, string> = {
  ...
  it: 'Italiano', ru: 'Russkiy', ja: 'Nihongo', ko: 'Hangugeo', zh: 'Zhongwen',
  ar: 'Arabic', hi: 'Hindi', tr: 'Turkce', pl: 'Polski', nl: 'Nederlands',
  sv: 'Svenska', id: 'Bahasa Indonesia', th: 'Thai', vi: 'Tieng Viet', uk: 'Ukrainska',
};

export interface Translations {
  welcomeEyebrow: string; welcomeTitle: string; welcomeDescription: string; welcomeCta: string;
  goalHeadline: string; goalSubheadline: string;
  goalViral: string; goalAccessible: string; goalBrand: string; goalFast: string; goalMultilingual: string; goalProfessional: string; goalCta: string;
  painHeadline: string; painSubheadline: string;
  painTyping: string; painTools: string; painCost: string; painTiming: string; painStyle: string; painOffline: string; painPrivacy: string;
  painCtaNone: string; painCtaSome: string;
  socialHeadline: string; socialSubheadline: string; socialCta: string;
  tinderHeadline: string; tinderSubheadline: string; tinderSkip: string; tinderRelate: string; tinderRemaining: string; tinderRemainingOne: string; tinderSkipRemaining: string;
  solutionHeadline: string; solutionSubheadline: string;
  solutionSpeedPain: string; solutionSpeedSolution: string; solutionSpeedStat: string;
  solutionPrivacyPain: string; solutionPrivacySolution: string; solutionPrivacyStat: string;
  solutionStylePain: string; solutionStyleSolution: string; solutionStyleStat: string;
  solutionCostPain: string; solutionCostSolution: string; solutionCostStat: string; solutionCta: string;
  prefHeadline: string; prefSubheadline: string; prefSectionFont: string; prefSectionColor: string; prefSectionEffect: string; prefCta: string;
  permHeadline: string; permSubheadline: string;
  permPhotoTitle: string; permPhotoBody: string; permSpeechTitle: string; permSpeechBody: string;
  permGranted: string; permEnable: string; permRequesting: string; permNotNow: string;
  procTitle: string; procSubtitle: string;
  demoHeadline: string; demoSubheadline: string; demoSectionFont: string; demoSectionAccent: string; demoSectionEffect: string; demoCta: string;
  valueTitle: string; valueBody: string;
  valueItem1Label: string; valueItem1Desc: string; valueItem2Label: string; valueItem2Desc: string; valueItem3Label: string; valueItem3Desc: string; valueCta: string;
  continue: string; skip: string; back: string;
}

const en: Translations = {
  welcomeEyebrow: 'Offline. Private. Instant.',
  welcomeTitle: 'Subtitles that make your clips impossible to scroll past',
  welcomeDescription: 'Import any video. Get perfectly timed, cinematic captions in under a minute. No uploads. No subscriptions. Just your phone.',
  welcomeCta: 'Get Started',
  goalHeadline: 'What are you trying to achieve?',
  goalSubheadline: 'Pick the one that matters most right now. We will tailor your experience around it.',
  ...
  painSubheadline: 'Select everything that frustrates you. We have been there too.',
  ...
  socialSubheadline: 'Join thousands who ditched manual captioning for good.',
  socialCta: 'Continue',
  tinderHeadline: 'Which statements do you relate to?',
  tinderSubheadline: 'Swipe right if it resonates. Swipe left to skip.',
  tinderSkip: 'Skip', tinderRelate: 'Relate',
  tinderRemaining: 'more cards', tinderRemainingOne: 'more card', tinderSkipRemaining: 'Skip remaining',
  solutionHeadline: 'Here is how Voxa fixes that',
  solutionSubheadline: 'You told us what frustrates you. Here is exactly what changes.',
  solutionSpeedPain: 'Captioning takes forever',
  solutionSpeedSolution: 'Auto-generate subtitles in under 60 seconds',
  solutionSpeedStat: 'On-device speech recognition — no waiting, no uploading',
  ...
  prefSubheadline: 'These are the defaults we will use for your first project. You can change them anytime.',
  prefSectionFont: 'Font', prefSectionColor: 'Accent Color', prefSectionEffect: 'Effect', prefCta: 'Continue',
  permHeadline: 'One last thing before we begin',
  permSubheadline: 'Voxa needs two permissions to work its magic. Everything stays offline.',
  permPhotoTitle: 'Photo Library',
  permPhotoBody: 'To import your videos and save finished clips back to your camera roll.',
  permSpeechTitle: 'Speech Recognition',
  permSpeechBody: 'To transcribe audio into subtitles directly on your device. No cloud involved.',
  permGranted: 'Granted', permEnable: 'Enable Access', permRequesting: 'Requesting...', permNotNow: 'Not now',
  procTitle: 'Setting things up', procSubtitle: 'Analyzing your preferences...',
  demoHeadline: 'Try it now',
  demoSubheadline: 'Pick a font, color, and effect. See your style come alive in real time.',
  demoSectionFont: 'Font', demoSectionAccent: 'Accent', demoSectionEffect: 'Effect', demoCta: 'I love this look',
  ...
  continue: 'Continue', skip: 'Skip', back: 'Back',
};

const es: Translations = {
  welcomeEyebrow: 'Sin conexion. Privado. Instantaneo.',
  welcomeTitle: 'Subtitulos que hacen que nadie pueda dejar de ver tus clips',
  welcomeDescription: 'Importa cualquier video. Consigue subtitulos cinematicos perfectamente sincronizados en menos de un minuto. Sin subidas. Sin suscripciones. Solo tu telefono.',
  welcomeCta: 'Empezar',
  goalHeadline: 'Que quieres lograr?',
  goalSubheadline: 'Elige lo que mas te importa ahora. Adaptaremos tu experiencia a ello.',
  ...
  painSubheadline: 'Selecciona todo lo que te frustra. Nosotros tambien lo hemos pasado.',
  ...
  socialSubheadline: 'Unete a miles que dejaron los subtitulos manuales para siempre.',
  socialCta: 'Continuar',
  ...
  tinderSkip: 'Saltar', tinderRelate: 'Identifico',
  tinderRemaining: 'tarjetas mas', tinderRemainingOne: 'tarjeta mas', tinderSkipRemaining: 'Saltar restantes',
  solutionHeadline: 'Asi es como Voxa lo soluciona',
  solutionSubheadline: 'Nos contaste que te frustra. Esto es exactamente lo que cambia.',
  ...
  solutionSpeedStat: 'Reconocimiento de voz en el dispositivo — sin esperas ni subidas',
  ...
  prefSubheadline: 'Estos seran los valores predeterminados para tu primer proyecto. Puedes cambiarlos cuando quieras.',
  prefSectionFont: 'Fuente', prefSectionColor: 'Color de acento', prefSectionEffect: 'Efecto', prefCta: 'Continuar',
  permHeadline: 'Una ultima cosa antes de empezar',
  permSubheadline: 'Voxa necesita dos permisos para funcionar. Todo se mantiene offline.',
  permPhotoTitle: 'Biblioteca de fotos',
  permPhotoBody: 'Para importar tus videos y guardar los clips terminados en tu carrete.',
  permSpeechTitle: 'Reconocimiento de voz',
  permSpeechBody: 'Para transcribir el audio a subtitulos directamente en tu dispositivo. Sin nube.',
  permGranted: 'Permitido', permEnable: 'Activar acceso', permRequesting: 'Solicitando...', permNotNow: 'Ahora no',
  procTitle: 'Preparando todo', procSubtitle: 'Analizando tus preferencias...',
  demoHeadline: 'Pruebalo ahora',
  demoSubheadline: 'Elige una fuente, color y efecto. Ve tu estilo cobrar vida en tiempo real.',
  demoSectionFont: 'Fuente', demoSectionAccent: 'Acento', demoSectionEffect: 'Efecto', demoCta: 'Me encanta este look',
  ...
  continue: 'Continuar', skip: 'Saltar', back: 'Atras',
};

const pt: Translations = {
  welcomeEyebrow: 'Offline. Privado. Instantaneo.',
  welcomeTitle: 'Legendas que fazem seus clips serem impossiveis de ignorar',
  welcomeDescription: 'Importe qualquer video. Obtenha legendas cinematicas perfeitamente sincronizadas em menos de um minuto. Sem uploads. Sem assinaturas. Apenas o seu celular.',
  welcomeCta: 'Comecar',
  goalHeadline: 'O que voce quer alcancar?',
  goalSubheadline: 'Escolha o que mais importa agora. Vamos adaptar sua experiencia para isso.',
  ...
  painSubheadline: 'Selecione tudo que te frustra. A gente tambem ja passou por isso.',
  ...
  socialSubheadline: 'Junte-se a milhares que abandonaram as legendas manuais de vez.',
  socialCta: 'Continuar',
  tinderHeadline: 'Com quais voce se identifica?',
  tinderSubheadline: 'Deslize para a direita se representa. Para a esquerda para pular.',
  tinderSkip: 'Pular', tinderRelate: 'Identifico',
  tinderRemaining: 'cartoes restantes', tinderRemainingOne: 'cartao restante', tinderSkipRemaining: 'Pular restantes',
  solutionHeadline: 'E assim que o Voxa resolve isso',
  solutionSubheadline: 'Voce nos contou o que te frustra. Isso e exatamente o que muda.',
  ...
  solutionSpeedStat: 'Reconhecimento de voz no dispositivo — sem esperas nem uploads',
  ...
  prefSubheadline: 'Esses serao os padroes do seu primeiro projeto. Voce pode mudar quando quiser.',
  prefSectionFont: 'Fonte', prefSectionColor: 'Cor de destaque', prefSectionEffect: 'Efeito', prefCta: 'Continuar',
  permHeadline: 'Uma ultima coisa antes de comecarmos',
  permSubheadline: 'O Voxa precisa de duas permissoes para funcionar. Tudo fica offline.',
  permPhotoTitle: 'Biblioteca de fotos',
  permPhotoBody: 'Para importar seus videos e salvar os clips prontos no seu rolo de camera.',
  permSpeechTitle: 'Reconhecimento de voz',
  permSpeechBody: 'Para transcrever o audio em legendas diretamente no seu dispositivo. Sem nuvem.',
  permGranted: 'Permitido', permEnable: 'Ativar acesso', permRequesting: 'Solicitando...', permNotNow: 'Agora nao',
  procTitle: 'Preparando tudo', procSubtitle: 'Analisando suas preferencias...',
  demoHeadline: 'Experimente agora',
  demoSubheadline: 'Escolha uma fonte, cor e efeito. Veja seu estilo ganhar vida em tempo real.',
  demoSectionFont: 'Fonte', demoSectionAccent: 'Destaque', demoSectionEffect: 'Efeito', demoCta: 'Adoro esse visual',
  ...
  continue: 'Continuar', skip: 'Pular', back: 'Voltar',
};

const fr: Translations = {
  welcomeEyebrow: 'Hors ligne. Prive. Instantane.',
  welcomeTitle: 'Des sous-titres qui rendent tes clips irresistibles',
  welcomeDescription: 'Importe n importe quelle video. Obtiens des legendes cinematographiques parfaitement synchronisees en moins d une minute. Pas d upload. Pas d abonnement. Juste ton telephone.',
  welcomeCta: 'Commencer',
  goalHeadline: 'Qu est-ce que tu veux accomplir ?',
  goalSubheadline: 'Choisis ce qui compte le plus pour toi maintenant. On adaptera ton experience.',
  ...
  painSubheadline: 'Selectionne tout ce qui t frustre. On a tous connu ca.',
  ...
  socialSubheadline: 'Rejoins les milliers qui ont definitivement lache les sous-titres manuels.',
  socialCta: 'Continuer',
  tinderHeadline: 'Avec lesquels tu te reconnais ?',
  tinderSubheadline: 'Swipe a droite si ca te parle. A gauche pour passer.',
  tinderSkip: 'Passer', tinderRelate: 'Ca me parle',
  tinderRemaining: 'cartes restantes', tinderRemainingOne: 'carte restante', tinderSkipRemaining: 'Passer le reste',
  solutionHeadline: 'Voici comment Voxa regle ca',
  solutionSubheadline: 'Tu nous as dit ce qui t frustre. Voici exactement ce qui change.',
  solutionSpeedPain: 'Les sous-titres prennent une eternite',
  solutionSpeedSolution: 'Genere automatiquement les sous-titres en moins de 60 secondes',
  solutionSpeedStat: 'Reconnaissance vocale sur l appareil — pas d attente, pas d upload',
  solutionPrivacyPain: 'J ai pas confiance dans les outils en ligne',
  solutionPrivacySolution: '100% hors ligne. Tes videos quittent jamais ton telephone',
  ...
  prefSubheadline: 'Ce seront les parametres par defaut pour ton premier projet. Tu peux changer quand tu veux.',
  prefSectionFont: 'Police', prefSectionColor: 'Couleur d accent', prefSectionEffect: 'Effet', prefCta: 'Continuer',
  permHeadline: 'Une derniere chose avant de commencer',
  permSubheadline: 'Voxa a besoin de deux permissions pour fonctionner. Tout reste hors ligne.',
  permPhotoTitle: 'Bibliotheque de photos',
  permPhotoBody: 'Pour importer tes videos et sauvegarder les clips finis dans ton pellicule.',
  permSpeechTitle: 'Reconnaissance vocale',
  permSpeechBody: 'Pour transcrire l audio en sous-titres directement sur ton appareil. Pas de cloud.',
  permGranted: 'Autorise', permEnable: 'Activer l acces', permRequesting: 'Demande en cours...', permNotNow: 'Pas maintenant',
  procTitle: 'Preparation en cours', procSubtitle: 'Analyse de tes preferences...',
  demoHeadline: 'Essaie maintenant',
  demoSubheadline: 'Choisis une police, une couleur et un effet. Regarde ton style prendre vie en temps reel.',
  demoSectionFont: 'Police', demoSectionAccent: 'Accent', demoSectionEffect: 'Effet', demoCta: 'J adore ce look',
  ...
  continue: 'Continuer', skip: 'Passer', back: 'Retour',
};

const de: Translations = {
  welcomeEyebrow: 'Offline. Privat. Sofort.',
  welcomeTitle: 'Untertitel, die deine Clips unwiderstehlich machen',
  welcomeDescription: 'Importiere jedes Video. Erhalte perfekt getimte, filmische Untertitel in unter einer Minute. Keine Uploads. Keine Abos. Nur dein Handy.',
  welcomeCta: 'Loslegen',
  goalHeadline: 'Was mochtest du erreichen?',
  goalSubheadline: 'Wahle das, was dir gerade am wichtigsten ist. Wir passen deine Erfahrung daran an.',
  ...
  painSubheadline: 'Wahle alles, was dich frustriert. Wir kennen das auch.',
  painTyping: 'Untertitel tippen dauert ewig',
  painTools: 'Online-Tools wirken unserios oder sind langsam',
  ...
  painOffline: 'Ich muss offline arbeiten konnen',
  painPrivacy: 'Ich will mein Material nicht in der Cloud',
  painCtaNone: 'Wahle mindestens eins aus',
  painCtaSome: 'Weiter',
  socialHeadline: 'Creator wie du sparen schon Stunden',
  socialSubheadline: 'Schliesse dich Tausenden an, die manuelle Untertitel endgultig hinter sich gelassen haben.',
  socialCta: 'Weiter',
  tinderHeadline: 'Mit welchen Aussagen kannst du dich identifizieren?',
  tinderSubheadline: 'Swipe rechts, wenn es dich trifft. Links zum Uberspringen.',
  tinderSkip: 'Uberspringen', tinderRelate: 'Trifft mich',
  tinderRemaining: 'Karten ubrig', tinderRemainingOne: 'Karte ubrig', tinderSkipRemaining: 'Rest uberspringen',
  solutionHeadline: 'So lost Voxa das',
  solutionSubheadline: 'Du hast uns gesagt, was dich frustriert. Das andert sich jetzt.',
  solutionSpeedPain: 'Untertitel dauern ewig',
  solutionSpeedSolution: 'Untertitel in unter 60 Sekunden automatisch generieren',
  solutionSpeedStat: 'Spracherkennung auf dem Gerat — kein Warten, kein Upload',
  solutionPrivacyPain: 'Ich traue Online-Tools nicht',
  solutionPrivacySolution: '100% offline. Deine Videos verlassen nie dein Handy',
  ...
  solutionCostStat: 'Alle Funktionen inklusive — keine Premium-Schranken',
  solutionCta: 'Zeig mir die Stile',
  prefHeadline: 'Wahle deinen Signature-Look',
  prefSubheadline: 'Das sind die Voreinstellungen fur dein erstes Projekt. Du kannst sie jederzeit andern.',
  prefSectionFont: 'Schriftart', prefSectionColor: 'Akzentfarbe', prefSectionEffect: 'Effekt', prefCta: 'Weiter',
  permHeadline: 'Noch eine Sache, bevor wir loslegen',
  permSubheadline: 'Voxa braucht zwei Berechtigungen, um zu funktionieren. Alles bleibt offline.',
  permPhotoTitle: 'Fotobibliothek',
  permPhotoBody: 'Um Videos zu importieren und fertige Clips zuruck in deine Kamerarolle zu speichern.',
  permSpeechTitle: 'Spracherkennung',
  permSpeechBody: 'Um Audio direkt auf deinem Gerat in Untertitel zu transkribieren. Keine Cloud.',
  permGranted: 'Erlaubt', permEnable: 'Zugriff aktivieren', permRequesting: 'Anfrage lauft...', permNotNow: 'Spater',
  procTitle: 'Alles vorbereiten', procSubtitle: 'Deine Vorlieben werden analysiert...',
  demoHeadline: 'Probier es aus',
  demoSubheadline: 'Wahle Schriftart, Farbe und Effekt. Sieh deinen Stil in Echtzeit zum Leben erwachen.',
  demoSectionFont: 'Schriftart', demoSectionAccent: 'Akzent', demoSectionEffect: 'Effekt', demoCta: 'Ich liebe diesen Look',
  valueTitle: 'Alles bereit',
  valueBody: 'Wir haben Voxa fur dich personalisiert, damit du',
  ...
  valueItem2Desc: 'Schriftart, Farbe und Effekt vorab ausgewahlt',
  valueItem3Label: 'Standardmassig privat',
  valueItem3Desc: 'Alles wird auf deinem Gerat verarbeitet',
  valueCta: 'Los geht s',
  continue: 'Weiter', skip: 'Uberspringen', back: 'Zuruck',
};

const it: Translations = {
  welcomeEyebrow: 'Offline. Privato. Istantaneo.',
  welcomeTitle: 'Sottotitoli che rendono i tuoi clip irresistibili',
  welcomeDescription: 'Importa qualsiasi video. Ottieni didascalie cinematografiche perfettamente sincronizzate in meno di un minuto. Nessun upload. Nessun abbonamento. Solo il tuo telefono.',
  welcomeCta: 'Inizia',
  goalHeadline: 'Cosa vuoi ottenere?',
  goalSubheadline: 'Scegli cio che conta di piu per te ora. Adatteremo la tua esperienza.',
  ...
  painSubheadline: 'Seleziona tutto cio che ti frustra. Anche noi ci siamo passati.',
  ...
  socialSubheadline: 'Unisciti a migliaia che hanno abbandonato i sottotitoli manuali per sempre.',
  socialCta: 'Continua',
  tinderHeadline: 'Con quali ti identifichi?',
  tinderSubheadline: 'Scorri a destra se ti rappresenta. A sinistra per saltare.',
  tinderSkip: 'Salta', tinderRelate: 'Mi identifico',
  tinderRemaining: 'carte rimaste', tinderRemainingOne: 'carta rimasta', tinderSkipRemaining: 'Salta le restanti',
  solutionHeadline: 'Ecco come Voxa risolve il problema',
  solutionSubheadline: 'Ci hai detto cosa ti frustra. Ecco esattamente cosa cambia.',
  ...
  solutionSpeedStat: 'Riconoscimento vocale sul dispositivo — nessuna attesa, nessun upload',
  solutionPrivacyPain: 'Non mi fido degli strumenti online',
  solutionPrivacySolution: '100% offline. I tuoi video non lasciano mai il telefono',
  ...
  prefSubheadline: 'Queste saranno le impostazioni predefinite per il tuo primo progetto. Puoi cambiarle quando vuoi.',
  prefSectionFont: 'Font', prefSectionColor: 'Colore accento', prefSectionEffect: 'Effetto', prefCta: 'Continua',
  permHeadline: 'Un ultima cosa prima di iniziare',
  permSubheadline: 'Voxa ha bisogno di due permessi per funzionare. Tutto rimane offline.',
  permPhotoTitle: 'Libreria foto',
  permPhotoBody: 'Per importare i tuoi video e salvare i clip finiti nel rullino.',
  permSpeechTitle: 'Riconoscimento vocale',
  permSpeechBody: 'Per trascrivere l audio in sottotitoli direttamente sul tuo dispositivo. Nessun cloud.',
  permGranted: 'Consentito', permEnable: 'Attiva accesso', permRequesting: 'Richiesta in corso...', permNotNow: 'Non ora',
  procTitle: 'Preparazione in corso', procSubtitle: 'Analisi delle tue preferenze...',
  demoHeadline: 'Provalo ora',
  demoSubheadline: 'Scegli un font, un colore e un effetto. Guarda il tuo stile prendere vita in tempo reale.',
  demoSectionFont: 'Font', demoSectionAccent: 'Accento', demoSectionEffect: 'Effetto', demoCta: 'Adoro questo look',
  ...
  continue: 'Continua', skip: 'Salta', back: 'Indietro',
};

const ru: Translations = {
  welcomeEyebrow: 'Offlain. Privatno. Mgnovenno.',
  welcomeTitle: 'Subtitry, iz-za kotorykh nevozmozhno proskrollit klip',
  welcomeDescription: 'Importirui liuboe video. Poluchi idealno sinkhronizirovannye kinematograficheskie subtitry menshe chem za minutu. Bez zagruzok. Bez podpisok. Tolko tvoi telefon.',
  welcomeCta: 'Nachat',
  goalHeadline: 'Chego ty khochesh dobitsia?',
  goalSubheadline: 'Vyberi to, chto vazhnee vsego priamo seichas. My podstroim opyt pod tebia.',
  ...
  painSubheadline: 'Vyberi vse, chto besit. My tozhe chereze eto prokhodili.',
  ...
  socialSubheadline: 'Prisoediniai sia k tysiacham, kto navsegda zabil pro ruchnye subtitry.',
  ...
  tinderSkip: 'Propustit', tinderRelate: 'Blizko',
  tinderRemaining: 'kart ostalos', tinderRemainingOne: 'karta ostalas', tinderSkipRemaining: 'Propustit ostavshiesia',
  solutionHeadline: 'Vot kak Voxa eto reshaet',
  solutionSubheadline: 'Ty rasskazal, chto besit. Vot chto konkretno izmenitsia.',
  solutionSpeedPain: 'Subtitry zanimaiut vechnost',
  solutionSpeedSolution: 'Avtogeneratsiia subtitrov menshe chem za 60 sekund',
  solutionSpeedStat: 'Raspoznavanie rechi na ustroistve — bez ozhidanii i zagruzok',
  solutionPrivacyPain: 'Ne doveriaiut onlain-instrumentam',
  solutionPrivacySolution: '100% offlain. Tvoi video nikogda ne pokidaiut telefon',
  ...
  solutionCostSolution: 'Odno prilozhenie. Bez reguliarnykh platezhei. Bez vodianykh znakov.',
  ...
  prefSubheadline: 'Eto budut nastroiki po umolchaniiu dlia pervogo proekta. Mozhesh pomeniat v liuboi moment.',
  prefSectionFont: 'Shrift', prefSectionColor: 'Aktsentnyi tsvet', prefSectionEffect: 'Effekt', prefCta: 'Prodolzhit',
  permHeadline: 'Poslednii shag pered startom',
  permSubheadline: 'Voxa nuzhno dva razresheniia, chtoby rabotat. Vse ostaetsia offlain.',
  permPhotoTitle: 'Fotoplienka',
  permPhotoBody: 'Chtoby importirovat video i sokhriniat gotovye klipy obratno v galeriiu.',
  permSpeechTitle: 'Raspoznavanie rechi',
  permSpeechBody: 'Chtoby transkribirovat audio v subtitry priamo na ustroistve. Bez oblaka.',
  permGranted: 'Razresheno', permEnable: 'Vkluchit dostup', permRequesting: 'Zaprashivaem...', permNotNow: 'Ne seichas',
  procTitle: 'Nastraivaem vse', procSubtitle: 'Analiziruem tvoi predpochteniia...',
  demoHeadline: 'Poprobui seichas',
  demoSubheadline: 'Vyberi shrift, tsvet i effekt. Uvid, kak stil ozhivaet v realnom vremeni.',
  demoSectionFont: 'Shrift', demoSectionAccent: 'Aktsent', demoSectionEffect: 'Effekt', demoCta: 'Obozhaiu etot stil',
  ...
  continue: 'Prodolzhit', skip: 'Propustit', back: 'Nazad',
};

const ja: Translations = {
  welcomeEyebrow: 'Offlain. Puraibeto. Sokuzani.',
  welcomeTitle: 'Sukurooru sasenai jimaku de, kurippu wo hikitomeru',
  welcomeDescription: 'Donna douga mo inpo-to. 1-fun inai ni kanpeki na shinematikkku jimaku wo seisei. Appuro-do fuyou. Sabusuku fuyou. Sumaho dake de kanketsu.',
  welcomeCta: 'Hajimeru',
  goalHeadline: 'Nani wo tasshi tai desu ka?',
  goalSubheadline: 'Ima motto mo taisetsu na koto wo eran de kudasai. Sore ni awasete taiken wo saiteki ka shimasu.',
  ...
  painSubheadline: 'Atte hamaru mono wo subete eran de kudasai. Watashitachi mo onaji keiken wo shiteimasu.',
  ...
  painCtaSome: 'Tsugi e',
  socialHeadline: 'Anata to onaji kurieita- ga, mou nanjikan mo setsuyaku shite iru',
  socialSubheadline: 'Shudou jimaku wo sotsugyou shita suusen nin no nakama ni hairou.',
  socialCta: 'Tsugi e',
  tinderHeadline: 'Kyoukan dekiru mono wa?',
  tinderSubheadline: 'Kyoukan dekitara migi he suwaipu. Sukippu wa hidari e.',
  tinderSkip: 'Sukippu', tinderRelate: 'Kyoukan',
  tinderRemaining: 'mai nokori', tinderRemainingOne: 'mai nokori', tinderSkipRemaining: 'Nokori wo sukippu',
  solutionHeadline: 'Voxa ga kou kaiketsu shimasu',
  solutionSubheadline: 'Anata no fuman wo kikimashita. Kore ga konkret ni kawaru koto desu.',
  solutionSpeedPain: 'Jimaku dzukuri ni jikan ga kakari sugiru',
  solutionSpeedSolution: '60-byou mi de jidou seisei',
  solutionSpeedStat: 'Debaisu nai onsei ninshiki — machi jikan zero, appuro-do fuyou',
  ...
  solutionCostSolution: 'Kono apuri hitotsu. Teiki kakin nashi. Uo-ta-ma-ku nashi.',
  ...
  prefSubheadline: 'Saisho no purojekuto no deforuto ni narimasu. Itsu demo henkou dekimasu.',
  prefSectionFont: 'Shotai', prefSectionColor: 'Akusento kara-', prefSectionEffect: 'Efekuto', prefCta: 'Tsugi e',
  permHeadline: 'Hajimeru mae ni saigo no kakunin',
  permSubheadline: 'Voxa ga sayou suru ni wa 2-tsu no kyoka ga hitsuyou desu. Subete offrain de okonawaremasu.',
  permPhotoTitle: 'Foto raiburari',
  permPhotoBody: 'Douga wo inpo-to shite, kansei shita kurippu wo kamera ro-ru ni hozon suru tame.',
  permSpeechTitle: 'Onsei ninshiki',
  permSpeechBody: 'Onsei wo tanmatsu jou de chokusetsu jimaku ni henkan suru tame. Kuraudo wa tsukaimasen.',
  permGranted: 'Kyoka sumi', permEnable: 'Kyoka suru', permRequesting: 'Rikuesuto chuu...', permNotNow: 'Ato de',
  procTitle: 'Junbi chuu', procSubtitle: 'Settei wo bunseki chuu...',
  demoHeadline: 'Ima sugu tamesu',
  demoSubheadline: 'Shotai, kara-, efekuto wo eran de, riarutaimu de sutairu wo kakunin shiyou.',
  demoSectionFont: 'Shotai', demoSectionAccent: 'Akusento', demoSectionEffect: 'Efekuto', demoCta: 'Kono sutairu ga ki ni itta',
  ...
  continue: 'Tsugi e', skip: 'Sukippu', back: 'Modoru',
};

const ko: Translations = {
  welcomeEyebrow: 'Opeurain. Peuraibit. Jiksi.',
  welcomeTitle: 'Seukeuroll-eul meomchuge mandeuneun jamak',
  welcomeDescription: 'Eotteon yeongsang-ideun gajeo oseyo. 1-bun an-e wanbyeokhage singkeu doen sinematig jamak-eul mandeulmida. Eopdeurodeu eopseum. Seobeuseukeub eopseum. Hyudaepon hanaro kkeut.',
  welcomeCta: 'Sijakhagi',
  goalHeadline: 'Mueos-eul ilugo sipeusin gayo?',
  goalSubheadline: 'Jigeum gajang jungyohan geos hana-reul gollajuseyo. Geu-e matchwo gyeongheom-eul jojeonghae deurimnida.',
  ...
  painSubheadline: 'Haedangdoeneun geos-eul modu seontaekhaejuseyo. Jeohuideudo da gyeokk-eobwasseoyo.',
  ...
  socialSubheadline: 'Sudeong jamak-eseo haebangdoen sucheon myeong-ui keurieiteodeul-e hamnyeo-haseyo.',
  socialCta: 'Gyesok',
  tinderHeadline: 'Gonggamdoeneun munjang-i issnayo?',
  tinderSubheadline: 'Gonggamdoemyeon oreunjjog-euro seuwaipeu. Neomgireun woenjjog-euro.',
  tinderSkip: 'Neomgigi', tinderRelate: 'Gonggam',
  tinderRemaining: 'jang nameum', tinderRemainingOne: 'jang nameum', tinderSkipRemaining: 'Nameun geos neomgigi',
  solutionHeadline: 'Voxa-neun ireoke haegyeolhamnida',
  solutionSubheadline: 'Bulpyeonhan jeom-eul deullyeojusyeosseoyo. Ijegumeonjeog dallajil jeom-ibnida.',
  solutionSpeedPain: 'Jamak mandeuneun de neo-mu orae geollim',
  solutionSpeedSolution: '60-cho an-e jadong-euro jamak saengseong',
  solutionSpeedStat: 'Gigi nae eumseong insik — daegi eobseum, eopdeurodeu eobseum',
  solutionPrivacyPain: 'Onlain tul-eul mot mitgesseum',
  solutionPrivacySolution: '100% opeurain. Yeongsang-eun jeoldae hyudaepon-eul beoseonaji aneum',
  ...
  solutionCostSolution: 'I aebeu hana. Banbok gyeolje eobseum. Woteomakeu eobseum.',
  ...
  prefSubheadline: 'Cheot peurojekteu-ui gibon-gabs-i doem니다. Eonjedeun byeongyeong hal su isseoyo.',
  prefSectionFont: 'Ponte-u', prefSectionColor: 'Gangjo saeksang', prefSectionEffect: 'Hyogwa', prefCta: 'Gyesok',
  permHeadline: 'Sijakhagi jeon majimak dangye',
  permSubheadline: 'Voxa-ga jaghadorago hamyeon du gaji gwonhan-i piryohamnida. Modeun cheori-neun opeurain-eseo irueojimnida.',
  permPhotoTitle: 'Sajin raibeureori',
  permPhotoBody: 'Yeongsang-eul gajeo-ogo wanseongdoen keullib-eul kaemera rol-e jeojang-hagi wihae piryohamnida.',
  permSpeechTitle: 'Eumseong insik',
  permSpeechBody: 'Odioreul gigi-eseo jikjeop jamak-euro byeongyeon-hagi wihae piryohamnida. Keullaudeu eobseum.',
  permGranted: 'Heoyongdoem', permEnable: 'Jeopgeun heoyong', permRequesting: 'Yocheung jung...', permNotNow: 'Najung-e',
  procTitle: 'Seoljeong jung', procSubtitle: 'Seonhodo bunseok jung...',
  demoHeadline: 'Jigeum baro cheheomhaeboseyo',
  demoSubheadline: 'Ponte-u, saeksang, hyogwa-reul goreugo sillsigan-euro seutail-i sarananeun geol hwagin-haseyo.',
  demoSectionFont: 'Ponte-u', demoSectionAccent: 'Gangjo', demoSectionEffect: 'Hyogwa', demoCta: 'I ruk ma-eum-e deureoyo',
  ...
  continue: 'Gyesok', skip: 'Geonneomugi', back: 'Dwiro',
};

const zh: Translations = {
  welcomeEyebrow: 'Li xian. Si mi. Ji ke.',
  welcomeTitle: 'Rang ren ting bu xia shou zhi de zi mu',
  welcomeDescription: 'Dao ru ren yi shi pin. Bu dao yi fen zhong ji ke huo de jing zhun tong bu de dian ying ji zi mu. Wu xu shang chuan. Wu xu ding yue. Zhi xu ni de shou ji.',
  welcomeCta: 'Kai shi',
  goalHeadline: 'Ni xiang da cheng shen me mu biao?',
  goalSubheadline: 'Xuan chu mu qian dui ni zui zhong yao de yi ge. Wo men hui wei rao ta wei ni ding zhi ti yan.',
  ...
  painSubheadline: 'Xuan chu suo you rang ni zhua kuang de xuan xiang. Wo men ye jing li guo.',
  ...
  socialSubheadline: 'Jia ru cheng qian shang wan che di gao bie shou dong zi mu de chuang zuo zhe hang lie.',
  socialCta: 'Ji xu',
  ...
  tinderSkip: 'Tiao guo', tinderRelate: 'Gong ming',
  tinderRemaining: 'zhang sheng yu', tinderRemainingOne: 'zhang sheng yu', tinderSkipRemaining: 'Tiao guo sheng yu',
  solutionHeadline: 'Voxa zhe yang jie jue ni de wen ti',
  solutionSubheadline: 'Ni gao su le wo men ni de frustrations. Yi xia shi ju ti hui gai bian de di fang.',
  solutionSpeedPain: 'Zuo zi mu hao shi tai jiu',
  solutionSpeedSolution: '60 miao nei zi dong sheng cheng zi mu',
  solutionSpeedStat: 'She bei duan yu yin shi bie — wu xu deng dai, wu xu shang chuan',
  ...
  prefSubheadline: 'Zhe jiang shi ni di yi ge xiang mu de mo ren she zhi. Sui shi ke yi geng gai.',
  prefSectionFont: 'Zi ti', prefSectionColor: 'Qiang tiao se', prefSectionEffect: 'Xiao guo', prefCta: 'Ji xu',
  permHeadline: 'Kai shi qian de zui hou yi bu',
  permSubheadline: 'Voxa xu yao liang xiang quan xian cai neng yun xing. Suo you chu li jun zai li xian zhuang tai xia wan cheng.',
  permPhotoTitle: 'Zhao pian tu ku',
  permPhotoBody: 'Yong yu dao ru shi pin bing jiang wan cheng de pian duan bao cun hui xiang ce.',
  permSpeechTitle: 'Yu yin shi bie',
  permSpeechBody: 'Yong yu zai she bei duan zhi jie jiang yin pin zhuan lu wei zi mu. Bu she ji yun duan.',
  permGranted: 'Yi yun xu', permEnable: 'Kai qi quan xian', permRequesting: 'Qing qiu zhong...', permNotNow: 'Shao hou zai shuo',
  procTitle: 'Zheng zai zhun bei', procSubtitle: 'Zheng zai fen xi ni de pian hao...',
  demoHeadline: 'Li ji ti yan',
  demoSubheadline: 'Xuan ze zi ti, yan se he xiao guo, shi shi yu lan ni de feng ge.',
  demoSectionFont: 'Zi ti', demoSectionAccent: 'Qiang tiao se', demoSectionEffect: 'Xiao guo', demoCta: 'Xi huan zhe ge feng ge',
  ...
  continue: 'Ji xu', skip: 'Tiao guo', back: 'Fan hui',
};

const ar: Translations = {
  welcomeEyebrow: 'Bidun intarnit. Khass. Fawri.',
  welcomeTitle: 'Tarjama takhalli al-mushahid ma yaqdir yatajawwaz maqati\'ak',
  welcomeDescription: 'Istawrid ayy fidyo. Ihsal ala tarjama sinamayiya mutazamana bishakl mithali fi aqall min daqiqa. Bidun raf\'. Bidun ishtirakat. Bas jawwak.',
  welcomeCta: 'Ibda\'',
  goalHeadline: 'Wash illi tahqiqah?',
  goalSubheadline: 'Ikhtar illi yihimmak al-hin. Rah nukhassis al-tajriba hawlah.',
  ...
  painSubheadline: 'Ikhtar kull illi yuda\'iqak. Ihna murrina binafs al-shay\'.',
  ...
  socialSubheadline: 'Inzam ila alaf illi taraku al-tarjama al-yadiyya nihaiyan.',
  socialCta: 'Istamirr',
  tinderHeadline: 'Ayy \'ibarat tash\'ur fiha?',
  tinderSubheadline: 'Is-hab yamin law tahs fiha. Yasar lit-takhti.',
  tinderSkip: 'Takhati', tinderRelate: 'Ahs fiha',
  tinderRemaining: 'bataqat mutabqiya', tinderRemainingOne: 'bataqa mutabqiya', tinderSkipRemaining: 'Takhati al-mutabqi',
  solutionHeadline: 'Kadha Voxa yahluha',
  solutionSubheadline: 'Qult lina wash illi yuda\'iqak. Hadhihi al-taghyirat bid-dabt.',
  solutionSpeedPain: 'Al-tarjama takhudh waqt tawil',
  solutionSpeedSolution: 'Tawlid tarjama tilqai\' fi aqall min 60 thaniya',
  solutionSpeedStat: 'Ta\'aruf sawti \'ala al-jihaz — bidun intizar wala raf\'',
  solutionPrivacyPain: 'Ma athiq bil-adawat al-onlayn',
  solutionPrivacySolution: '100% bidun nit. Maqati\'ak ma titla\' min jawwalk',
  ...
  solutionCostSolution: 'Tatbiq wahid. Bidun rusum dooriyya. Bidun \'alama mayyiyya.',
  ...
  prefSubheadline: 'Hadhi al-i\'adat al-iftira\'iyya li-mashru\'ak al-awwal. Tiqdar taghyirha matma tibgha.',
  prefSectionFont: 'Al-khatt', prefSectionColor: 'Lawn al-tamayyuz', prefSectionEffect: 'Al-athar', prefCta: 'Istamirr',
  permHeadline: 'Shay\' akhir qabla ma nabda\'',
  permSubheadline: 'Voxa yahtaju tasrihayn yashtaghil. Kull shay\' yabqa bidun nit.',
  permPhotoTitle: 'Maktabat al-suwar',
  permPhotoBody: 'Li-istirad fidiyuhatak wa-hifz al-maqati\' al-jahiza fi album al-kamira.',
  permSpeechTitle: 'Ta\'aruf al-kalam',
  permSpeechBody: 'Li-tahwil al-sawt ila tarjama mubasharatan \'ala jihazak. Bidun sahaba.',
  permGranted: 'Musmuh', permEnable: 'Taf\'il al-wusul', permRequesting: 'Qiyam al-talab...', permNotNow: 'Mush al-hin',
  procTitle: 'Jari al-tajhiz', procSubtitle: 'Jari tahlll afdaliyyatik...',
  demoHeadline: 'Jarrab al-hin',
  demoSubheadline: 'Ikhtar khatt wa-lawn wa-athar. Shuf tab\'ak yitla\' hayy bi-l-waqt al-haqiqi.',
  demoSectionFont: 'Al-khatt', demoSectionAccent: 'Al-tamayyuz', demoSectionEffect: 'Al-athar', demoCta: '\'Jabni hatha al-tab\'',
  ...
  continue: 'Istamirr', skip: 'Takhati', back: 'Ruju\'',
};
